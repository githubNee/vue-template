...
<div class="">
  <el-form :model="dynamicValidateForm" ref="dynamicValidateForm" label-width="150px" class="demo-dynamic">
    <el-form-item prop="" label="第一个参数" :rules="[
      { required: true, message: '请输入第一个参数', trigger: 'blur' }
    ]">
      <el-input v-model="dynamicValidateForm.email"></el-input>
    </el-form-item>
    <el-form-item prop="" label="第一个符号位" :rules="[
      { required: true, message: '请输入第二个参数', trigger: 'blur' }
    ]">
      <el-input v-model="dynamicValidateForm.email"></el-input>
    </el-form-item>
    <el-form-item prop="email" label="第三个参数" :rules="[
      { required: true, message: '请输入第一个参数', trigger: 'blur' }
    ]">
      <el-input v-model="dynamicValidateForm.email"></el-input>
    </el-form-item>
